...
Assets are organized by semantic entity rather than provider identifier. Catalog-backed entity folders use Prool catalog keys when they exist; otherwise, new entity folders use kebab-case. Versioning should be visible in the path or filename so new published assets can be added without overwriting existing URLs; for example, tournament logos can use an edition filename such as `images/country/england/tournaments/premier-league/logo/2026-27.svg`, and team jerseys can use `images/country/england/teams/arsenal/jersey/2026-27.svg`.
